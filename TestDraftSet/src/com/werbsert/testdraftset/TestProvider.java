...
import com.werbsert.testdraftset.db.CardDatabaseHelper;
import com.werbsert.testdraftset.db.CardTable;
...
public class TestProvider 
	...
	static {
		s_uriMatcher.addURI(DraftContract.TestDraftSet.AUTHORITY, DraftContract.TestDraftSet.TYPE, QUERY_CARD);
		s_uriMatcher.addURI(DraftContract.TestDraftSet.AUTHORITY, DraftContract.TestDraftSet.TYPE + "/#", QUERY_CARD_ID);
	}
	...
	public Uri insert(Uri uri, ContentValues values) {
	    ...
	    return Uri.parse(DraftContract.TestDraftSet.TYPE + "/" + insertId);
	}
